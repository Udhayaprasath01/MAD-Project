...
public class FamilyTest extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        quizText.setText("Family Members");

        //This will return us a list of data type TriviaQuestion
        list = new ArrayList<Question>();
        list.add(new Question("father", "әpә", "әṭa", "taachi","chalitti","әpә"));
        list.add(new Question("mother", "әṭa", "chalitti", "әpә","tune","әṭa"));
        list.add(new Question("son", "angsi", "әṭa", "chalitti","paapa", "angsi"));
        list.add(new Question("daughter", "tune", "angsi", "әpә","tune", "tune"));
        list.add(new Question("older brother", "taachi", "angsi", "әpә","chalitti","taachi"));
        list.add(new Question("younger brother", "taachi", "angsi","әpә", "chalitti","chalitti"));
        list.add(new Question("older sister", "teṭe", "taachi", "angsi",  "chalitti","teṭe"));
        list.add(new Question("younger sister", "kolliti", "paapa", "angsi", "ama","kolliti"));
        list.add(new Question("grandmother ", "ama", "kolliti", "angsi", "әpә","ama"));
        list.add(new Question("grandfather", "paapa", "kolliti", "angsi", "әpә","paapa"));
    ...
    public void gameWon() {
        ...
        intent.putExtra("activity","Family");
    ...
    public void correctDialog() {
        final Dialog dialogCorrect = new Dialog(FamilyTest.this);
